...
function TermsCondition() {
    return (
        <div>
            ...
            <p>Interfere with another&rsquo;s utilization and enjoyment of the Site;</p>
            <p>Post, promote or transmit through the Site any prohibited materials as deemed illegal by The People&apos;s Republic of Bangladesh.</p>
            ...
            <p>to send, use or reuse any material that does not belong to you; or is illegal, offensive (including but not limited to material that is sexually explicit content or which promotes racism, bigotry, hatred or physical harm), deceptive, misleading, abusive, indecent, harassing, blasphemous, defamatory, libellous, obscene, pornographic, paedophilic or menacing; ethnically objectionable, disparaging or in br/each of copyright, trademark, confidentiality, privacy or any other proprietary information or right; or is otherwise injurious to third parties; or relates to or promotes money laundering or gambling; or is harmful to minors in any way; or impersonates another person; or threatens the unity, integrity, security or sovereignty of Bangladesh or friendly relations with foreign States; or objectionable or otherwise unlawful in any manner whatsoever; or which consists of or contains software viruses, political campaigning, commercial solicitation, chain letters, mass mailings or any &quot;spam&rdquo;</p>
            <p>Use the Site for illegal purposes.</p>
            ...
            <p><br/></p>
            <p>L. INDEMNITY</p>
            <p>You shall indemnify and hold harmless Daraz as owned by Daraz Singapore Private Limited, its subsidiaries, affiliates and their respective officers, directors, agents and employees, from any claim or demand, or actions including reasonable attorney&apos;s fees, made by any third party or penalty imposed due to or arising out of your br/each of these Terms and Conditions or any document incorporated by reference, or your violation of any law, rules, regulations or the rights of a third party.</p>
            <p><br/></p>
            <p>You hereby expressly release Daraz as owned by Daraz Singapore Private Limited and/or its affiliates and/or any of its officers and representatives from any cost, damage, liability or other consequence of any of the actions/inactions of the sellers or other service providers and specifically waiver any claims or demands that you may have in this behalf under any statute, contract or otherwise.</p>
            <p><br/></p>
            <p>Back to Top</p>
            <p><br/></p>
            ...
            <p><br/></p>
            <p>D. RETURNS</p>
            <p>Please review our Returns Policy here.</p>
            <p><br/></p>
            <p>Back to Top</p>
            <p><br/></p>
            ...
            <p>Refund Voucher code can be applied only once. The residual amount of the Refund Voucher after applying it once, if any, will not be refunded and cannot be used for next purchases even if the value of order is smaller than remaining voucher value.</p>
            <p>Promotional Vouchers</p>
            ...
            <p>Both promotional voucher and cart rule discount may not be added at the same time.</p>
            ...
            <p>Daraz reserves the right to vary or terminate the operation of any voucher at any time without notice.</p>
            <p>Daraz shall not be liable to any customer or household for any financial loss arising out of the refusal, cancellation or withdrawal of any voucher or any failure or inability of a customer to use a voucher for any reason.</p>
            <p>Vouchers are not replaceable if expired.</p>
            <p>No promotional offer can be made for baby nutrition products.</p>
            <p>Reward Vouchers</p>
            <p>Customers who have already been listed in Daraz for fraudulent activities will not be eligible to avail any voucher and will not be eligible to participate in any campaign.</p>
            <p>A customer shall not operate more than one account in a single device.</p>
            <p>Promotional Items</p>
            <p>One customer will be able to purchase one 11tk deal and mystery box during the promotional period.</p>
            <p>Security and Fraud</p>
            <p>When you use a voucher, you warrant to Daraz that you are the duly authorized recipient of the voucher and that you are using it in good faith.</p>
            ...
            <p>If we reasonably believe that any voucher is being used unlawfully or illegally we may reject or cancel any voucher/order and you agree that you will have no claim against us in respect of any rejection or cancellation. Daraz reserves the right to take any further action it deems appropriate in such instances</p>
            <p>Back to Top</p>
            <p><br/></p>
            ...
            <p><br/></p>
            <p>We are not responsible for any non-performance or br/each of any contract entered into between you and the sellers. We cannot and do not guarantee your actions or those of the sellers as they conclude transactions on the Site. We are not required to mediate or resolve any dispute or disagreement arising from transactions occurring on our Site.</p>
            <p><br/></p>
            ...
            <p><br/></p>
            <p>I. OTHERS</p>
            <p>Stock availability: The orders are subject to availability of stock.</p>
            <p><br/></p>
            <p>Delivery Timeline: The delivery might take longer than usual timeframe/line to be followed by Daraz.</p>
            <p>Delivery might be delayed due to force majeure event which includes, but not limited to, political unrest, political event, national/public holidays,etc</p>
            <p><br/></p>
            <p>Cancellation: Daraz retains unqualified right to cancel any order at its sole discretion prior to dispatch and for any reason which may include, but not limited to, the product being mispriced, out of stock, expired, defective, malfunctioned, and containing incorrect information or description arising out of technical or typographical error or for any other reason.</p>
            <p><br/></p>
            <p>Refund Timeline: If any order is canceled, the payment against such order shall be refunded within 10 to 15 working days, but it may take longer time in exceptional cases. Provided that received cash back amount, if any, will be adjusted with the refund amount.</p>
            <p>Back to Top</p>
            <p><br/></p>
